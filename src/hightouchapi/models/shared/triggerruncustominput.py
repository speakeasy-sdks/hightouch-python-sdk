...
class TriggerRunCustomInput:
    ...
    full_resync: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fullResync'), 'exclude': lambda f: f is None }})
    ...
    sync_slug: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('syncSlug'), 'exclude': lambda f: f is None }})
