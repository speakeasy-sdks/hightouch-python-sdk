...
class UpdateSourceResponse:
    ...
    update_source_200_application_json_one_of: Optional[Union[shared_source.Source, shared_validateerrorjson.ValidateErrorJSON, str]] = dataclasses.field(default=None)
    r"""Ok"""
