...
class ListSyncQueryParamOrderBy(str, Enum):
    r"""specify the order"""
    ID = 'id'
    NAME = 'name'
    SLUG = 'slug'
...
class ListSyncRequest:
    ...
    order_by: Optional[ListSyncQueryParamOrderBy] = dataclasses.field(default=ListSyncQueryParamOrderBy.ID, metadata={'query_param': { 'field_name': 'orderBy', 'style': 'form', 'explode': True }})
    r"""specify the order"""
...
class ListSyncResponse:
    ...
    object: Optional[ListSyncResponseBody] = dataclasses.field(default=None)
    r"""Ok"""
